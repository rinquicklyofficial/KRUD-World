...
import dev.krud.world.core.scripting.environment.SimpleEnvironment
import dev.krud.world.core.scripting.kotlin.base.*
import dev.krud.world.core.scripting.kotlin.runner.FileComponents
import dev.krud.world.core.scripting.kotlin.runner.Script
import dev.krud.world.core.scripting.kotlin.runner.ScriptRunner
import dev.krud.world.core.scripting.kotlin.runner.classpath
import dev.krud.world.core.scripting.kotlin.runner.value
...
open class KrudWorldSimpleExecutionEnvironment internal constructor(
    baseDir: File,
    parent: ScriptRunner?
) : SimpleEnvironment {
    @JvmOverloads
    ...
    override fun execute(
        ...
        KrudWorld.debug("Execute Script (void) " + C.DARK_GREEN + script)
    ...
    override fun evaluate(
        ...
        KrudWorld.debug("Execute Script (for result) " + C.DARK_GREEN + script)
    ...
    companion object {
        ...
        private fun List<String>.updateClasspath(classpath: List<File>): String {
            ...
            classpath.forEach {
                ...
                if (parts.size <= 1) {
                    KrudWorld.error("Invalid classpath entry: $it")
                    return@forEach
                }
