...
import dev.krud.world.util.function.Function4;
...
import dev.krud.world.util.stream.arithmetic.*;
import dev.krud.world.util.stream.convert.*;
import dev.krud.world.util.stream.interpolation.Interpolated;
import dev.krud.world.util.stream.sources.FunctionStream;
import dev.krud.world.util.stream.utility.*;
...
public interface ProceduralStream<T> extends ProceduralLayer, Interpolated<T> {
    ...
    default ProceduralStream<Double> style(RNG rng, KrudWorldStyledRange range, KrudWorldData data) {
