...
public class KrudWorldMathHelper {
    ...
    static {
        ...
        for (int var2 = 0; var2 < 257; ++var2) {
            ...
            KrudWorldMathHelper.g[var2] = Math.cos(var4);
            KrudWorldMathHelper.f[var2] = var4;
        }
    }
    ...
    public static int e(int var0) {
        ...
        return KrudWorldMathHelper.d[(int) (var0 * 125613361L >> 27) & 0x1F];
    }
    ...
    public static UUID a() {
        return a(KrudWorldMathHelper.c);
    }
    ...
    public static double d(double var0, double var2) {
        ...
        var2 *= var7;
        var0 *= var7;
        final double var8 = KrudWorldMathHelper.e + var0;
        final int var9 = (int) Double.doubleToRawLongBits(var8);
        final double var10 = KrudWorldMathHelper.f[var9];
        final double var11 = KrudWorldMathHelper.g[var9];
        final double var12 = var8 - KrudWorldMathHelper.e;
