...
import dev.krud.world.util.cache.FloatCache;
import dev.krud.world.util.collection.KList;
import dev.krud.world.util.format.Form;
import dev.krud.world.util.function.NoiseInjector;
...
import dev.krud.world.util.stream.arithmetic.FittedStream;
import dev.krud.world.util.stream.sources.CNGStream;
import lombok.Data;
    ...
    public CNG cached(int size, String key, File cacheFolder) {
        ...
        if (!cached) {
            ...
            try {
                ...
                fbc.writeCache(dos);
                dos.close();
                KrudWorld.info("Saved Noise Cache " + f.getName());
            } catch (IOException e) {
