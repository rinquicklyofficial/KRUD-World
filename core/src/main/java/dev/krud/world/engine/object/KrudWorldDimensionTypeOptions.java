...
public class KrudWorldDimensionTypeOptions {
    @MinNumber(0.00001)
    @MaxNumber(30000000)
    ...
    public KrudWorldDimensionTypeOptions(
    ...
    public KrudWorldDimensionTypeOptions coordinateScale(double coordinateScale) {
        if (coordinateScale != -1 && (coordinateScale < 0.00001 || coordinateScale > 30000000))
            throw new IllegalArgumentException("Coordinate scale must be between 0.00001 and 30000000");
        this.coordinateScale = coordinateScale;
        return this;
    ...
    public KrudWorldDimensionTypeOptions ambientLight(float ambientLight) {
        if (ambientLight != -1 && (ambientLight < 0 || ambientLight > 1))
            throw new IllegalArgumentException("Ambient light must be between 0 and 1");
        this.ambientLight = ambientLight;
        return this;
    ...
    public KrudWorldDimensionTypeOptions cloudHeight(@Nullable Integer cloudHeight) {
        if (cloudHeight != null && cloudHeight != -1 && (cloudHeight < -2032 || cloudHeight > 2031))
            throw new IllegalArgumentException("Cloud height must be between -2032 and 2031");
        this.cloudHeight = cloudHeight;
        return this;
    ...
    public KrudWorldDimensionTypeOptions monsterSpawnBlockLightLimit(int monsterSpawnBlockLightLimit) {
        if (monsterSpawnBlockLightLimit != -1 && (monsterSpawnBlockLightLimit < 0 || monsterSpawnBlockLightLimit > 15))
            throw new IllegalArgumentException("Monster spawn block light limit must be between 0 and 15");
        this.monsterSpawnBlockLightLimit = monsterSpawnBlockLightLimit;
        return this;
    ...
    public KrudWorldDimensionTypeOptions read(DataInput dis) throws IOException {
    ...
    public KrudWorldDimensionTypeOptions resolve(KrudWorldDimensionTypeOptions other) {
    ...
    public KrudWorldDimensionTypeOptions copy() {
        return new KrudWorldDimensionTypeOptions(
                ultrawarm,
                natural,
                piglinSafe,
                respawnAnchorWorks,
