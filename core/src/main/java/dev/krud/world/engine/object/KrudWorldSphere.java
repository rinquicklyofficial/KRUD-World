...
@Data
public class KrudWorldSphere implements IRare {
    ...
    private KrudWorldStyledRange radius = new KrudWorldStyledRange(1, 5, new KrudWorldGeneratorStyle(NoiseStyle.STATIC));
