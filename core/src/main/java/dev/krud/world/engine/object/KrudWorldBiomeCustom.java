...
@Data
public class KrudWorldBiomeCustom {
    @Required
    ...
    @ArrayType(min = 1, type = KrudWorldBiomeCustomSpawn.class)
    @Desc("The biome's mob spawns")
    private KList<KrudWorldBiomeCustomSpawn> spawns = new KList<>();

    @Desc("The biome's downfall type")
    private KrudWorldBiomeCustomPrecipType downfallType = KrudWorldBiomeCustomPrecipType.rain;

    @Desc("Define an ambient particle to be rendered clientside (no server cost!)")
    private KrudWorldBiomeCustomParticle ambientParticle = null;

    @Required
    @Desc("The biome's category type")
    private KrudWorldBiomeCustomCategory category = KrudWorldBiomeCustomCategory.plains;
    ...
    public String generateJson(IDataFixer fixer) {
        ...
        j.put("has_precipitation", getDownfallType() != KrudWorldBiomeCustomPrecipType.none);
        ...
        if (getSpawns() != null && getSpawns().isNotEmpty()) {
            ...
            for (KrudWorldBiomeCustomSpawn i : getSpawns()) {
