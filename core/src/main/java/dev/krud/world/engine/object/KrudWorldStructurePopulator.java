...
public class KrudWorldStructurePopulator extends EngineAssignedComponent {
    private final CNG cng;
    private final long mantle;
    private final long jigsaw;

    public KrudWorldStructurePopulator(Engine engine) {
    ...
    private boolean place(BiPredicate<String, Boolean> placer, KList<KrudWorldJigsawStructurePlacement> placements, long seed, int x, int z) {
    ...
    @ChunkCoordinates
    private boolean place(BiPredicate<String, Boolean> placer, KrudWorldJigsawStructure structure, RNG rng, boolean ignoreBiomes) {
