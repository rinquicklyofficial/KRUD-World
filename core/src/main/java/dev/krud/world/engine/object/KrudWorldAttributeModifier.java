...
@Data
public class KrudWorldAttributeModifier {
    @Required
    ...
    @Desc("Minimum amount for this modifier. KrudWorld randomly chooses an amount, this is the minimum it can choose randomly for this attribute.")
    private double minAmount = 1;

    @Desc("Maximum amount for this modifier KrudWorld randomly chooses an amount, this is the maximum it can choose randomly for this attribute.")
    private double maxAmount = 1;

    @MinNumber(0)
    @MaxNumber(1)
    @Desc("The chance that this attribute is applied (0 to 1). If the chance is 0.5 (50%), then KrudWorld will only apply this attribute 50% of the time.")
