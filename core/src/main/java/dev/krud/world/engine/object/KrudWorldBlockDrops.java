...
@Data
public class KrudWorldBlockDrops {
    ...
    private KList<KrudWorldBlockData> blocks = new KList<>();
    ...
    private KList<KrudWorldLoot> drops = new KList<>();
    ...
    public boolean shouldDropFor(BlockData data, KrudWorldData rdata) {
        KList<BlockData> list = this.data.aquire(() -> {
            KList<BlockData> b = new KList<>();

            for (KrudWorldBlockData i : getBlocks()) {
