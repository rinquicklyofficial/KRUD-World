...
public class KrudWorldSeaSurfaceDecorator extends KrudWorldEngineDecorator {
    public KrudWorldSeaSurfaceDecorator(Engine engine) {
        super(engine, "Sea Surface", KrudWorldDecorationPart.SEA_SURFACE);
    }
