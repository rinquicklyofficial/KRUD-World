...
import dev.krud.world.core.service.ObjectSVC;
import dev.krud.world.core.service.StudioSVC;
import dev.krud.world.core.service.WandSVC;
import dev.krud.world.core.tools.KrudWorldConverter;
...
import dev.krud.world.util.data.registry.Materials;
...
import dev.krud.world.util.math.Direction;
...
@Decree(name = "object", aliases = "o", origin = DecreeOrigin.PLAYER, studio = true, description = "KrudWorld object manipulation")
public class CommandObject implements DecreeExecutor {
    ...
    public void position2(
        ...
        if (WandSVC.isHoldingKrudWorldWand(player())) {
            Location[] g = WandSVC.getCuboid(player());
...
//            KrudWorldObjectPlacementScaleInterpolator interpolator
    ) {
        KrudWorldObject o = KrudWorldData.loadAnyObject(object, data());
        ...
        KrudWorldObjectPlacement placement = new KrudWorldObjectPlacement();
        placement.setRotation(KrudWorldObjectRotation.of(0, rotate, 0));
        ...
        if (scale != 1) {
            o = o.scaled(scale, KrudWorldObjectPlacementScaleInterpolator.TRICUBIC);
        }
        ...
        KrudWorld.service(ObjectSVC.class).addChanges(futureChanges);
    ...
    public void save(
        ...
        KrudWorldObject o = WandSVC.createSchematic(player(), legacy);
        ...
        File file = KrudWorld.service(StudioSVC.class).getWorkspaceFile(dimension.getLoadKey(), "objects", name + ".iob");
    ...
    public void undo(
        ...
        ObjectSVC service = KrudWorld.service(ObjectSVC.class);
