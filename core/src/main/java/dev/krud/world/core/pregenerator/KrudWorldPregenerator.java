...
public class KrudWorldPregenerator {
    ...
    private final KrudWorldPackBenchmarking benchmarking;

    public KrudWorldPregenerator(PregenTask task, PregeneratorMethod generator, PregenListener listener) {
        benchmarking = KrudWorldPackBenchmarking.getInstance();
        ...
        ticker = new Looper() {
            ...
            protected long loop() {
                ...
                if (cl.flip()) {
                    ...
                    KrudWorld.info("<gray>⏳ Pregenerating: <gradient:#a855f7:#f59e0b>%.0f%%</gradient> " +
                                    "<white>%s chunks | <gray>ETA: <white>%s",
                            percentage,
    ...
    public void start() {
        ...
        KrudWorld.info("Pregen took " + Form.duration((long) p.getMilliseconds()));
        shutdown();
        if (benchmarking == null) {
            KrudWorld.info(C.IRIS + "Pregen stopped.");
        } else {
