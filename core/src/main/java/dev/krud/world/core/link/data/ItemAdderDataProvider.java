...
public class ItemAdderDataProvider extends ExternalDataProvider {
    ...
    public BlockData getBlockData(@NotNull Identifier blockId, @NotNull KMap<String, String> state) throws MissingResourceException {
        ...
        return KrudWorldCustomData.of(block.getBaseBlockData(), blockId);
    }
    ...
    private void updateNamespaces() {
        try {
            ...
            KrudWorld.warn("Failed to update ItemAdder namespaces: " + e.getMessage());
        }
    }
    ...
    private void updateNamespaces(DataType dataType) {
        ...
        KrudWorld.debug("Updated ItemAdder namespaces: " + dataType + " - " + namespaces);
    }
