...
package dev.krud.world.core.nms.v1X;
...
public class NMSBinding1X implements INMSBinding {
    ...
    public MCABiomeContainer newBiomeContainer(int min, int max) {
        KrudWorld.error("Cannot use the custom biome data! KrudWorld is incapable of using MCA generation on this version of minecraft!");
    ...
    public MCAPaletteAccess createPalette() {
        KrudWorld.error("Cannot use the global data palette! KrudWorld is incapable of using MCA generation on this version of minecraft!");
        return null;
    }
}
