...
public abstract class ExternalDataProvider implements Listener {
     ...
     * it is used in any place KrudWorld accepts {@link BlockData}
     *
     ...
     *         may return {@link KrudWorldCustomData} for blocks that need a world for placement
     ...
     * it will only be called when the {@link ExternalDataProvider#getBlockData(Identifier, KMap)} returned a {@link KrudWorldCustomData}
     *
